...
- item:
  ...
  body: "<p>Although Twitter published more comprehensive data on the number of actions it took to enforce its own rules, it was less clear about its commitment to publish this data at least once a year, and it no longer made this data available for export as a structured data file.</p>"
- item:
  change: true
  title: F5. Process for responding to third-party requests for content or account restriction
  body: "<p>Twitter disclosed more about how it responds to government requests to restrict access to content and accounts, although it no longer provided an example to help users understand how it implements its process of responding to government removal requests for Periscope. </p>"
- item:
  change: false
  title: F6. Data about government requests for content or account restriction
  body: "<p>While Twitter disclosed the number of terms of service removal requests submitted by governments, it stopped listing the number of Periscope accounts and pieces of content affected by government removal requests.</p>"
- item:
  change: true
  title: F8. User notification about content and account restriction
  body: "<p>Twitter improved its disclosure regarding its policies for notifying users attempting to access restricted content. </p>"
privacy_value: 55
privacy_text: | 
...
- item:
  ...
  body: "<p>Twitter no longer disclosed whether it deletes all user information after users terminate their accounts.</p>"
- item:
  change: true
...
- item:
  ...
  body: "<p>Twitter improved its disclosure of the purposes for which it collects user information from third-parties through technical means.</p>"
footnotes: | 

...
<div class="dotchart--<%= className %>">
  ...
  <span class="dot <%= dot[0].className %>" data-val="<%= dot[0].val %>" style="left: <%= +dot[0].val %>%"></span>
  <% }); %>
  <label class="dotchart--label dotchart--label_highlight" style="left: <%= highlight.val %>%">
